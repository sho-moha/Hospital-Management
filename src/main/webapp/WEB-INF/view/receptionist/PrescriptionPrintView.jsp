...
<script>
	...
	<div class="container"><br/>
		...
		<div class="row">
			<div class="col-sm-5">
			<h1><span style="font-weight:bold;color:red; ">Montreal Memorial</span></h1>
			</div>
			<div class="col-sm-7">
			<p><b>Dr. Paula Abdul</b><br/> MBBS, DNB(Gen. Surgeon), MS, MNAMS, FMAS, FIAGES, FALS, AFIH</p>
			</div>
		</div>
		<hr/>
	<div class="demo">
			...
			<div>
				...
				<hr/>
				Our Center:<br/>
			    1. Montreal Memorial Hospital, Montreal, Quebec, Canada |<br/>
			    Mobile No. 5147030000 | Fax No. 514-2575151 | E-mail: abdulp@gmail.com	
			</div>	
