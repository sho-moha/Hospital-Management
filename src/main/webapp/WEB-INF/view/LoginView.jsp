...
<body>
    ...
    <form action="dashboard.html" method="post" autocomplete="off">
		...
		<div style="text-align: right;"  onmouseover="myFunction()" onmouseout ="demo()"> Help? </div>
...
<script>
	function myFunction() 
	{
	  document.getElementById("demo").innerHTML = "Note: Your Default USERNAME is ID and PASSWORD is RAMQ NUMBER";
	}
