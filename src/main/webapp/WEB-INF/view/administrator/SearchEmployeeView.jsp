...
.main {
  ...
  background-image: url("/HospitalManagement/resources/images/search.jpg");
	   ...
	   <div class="col-sm-12">
	      <!-- display window -->
			...
			<div class="card bg-light border-warning mb-3" >
			  <div class="card-header"><h4>By RAMQ No</h4></div>
			  <div class="card-body">
			    <p class="card-text">
			    	<form action="searchEmployeeByRAMQNo.html" method="post" >
						 <div class="form-group">
						 	<label>RAMQ No</label>
						 	<input type="text" class="form-control" id="exampleInputEmail1" name="ramqNo" placeholder="12 digit"
