...
public class SearchEmployeeController 
{
	...
	@RequestMapping(value="/searchEmployeeByRAMQNo.html", method = RequestMethod.POST)
	public ModelAndView searchAadharNo(@RequestParam("ramqNo")String ramqNo)
	{
		Employee e1= dao.searchRAMQNo(ramqNo);
		infoLog.logActivities(""+e1);
	    try {
			if(e1.getEid()!=null)
			{
