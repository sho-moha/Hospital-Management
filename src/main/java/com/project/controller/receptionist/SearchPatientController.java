...
public class SearchPatientController 
{
	...
	@RequestMapping(value="/searchPatientByRAMQNo.html", method = RequestMethod.POST)
	public ModelAndView searchAdharNo(@RequestParam("ramqNo")Long ramqNo)
	{
		try {
			infoLog.logActivities("in SearchPatientController-searchRAMQNo: got= "+ramqNo);
			Patient p1= dao.searchRamqNo(ramqNo);
			infoLog.logActivities("returned to in SearchPatientController-searchRAMQNo: got= "+p1);
			
			String doctorAssigned=dao.searchDoctorAssigned(p1.getDoctorId());
			infoLog.logActivities("returned to in SearchPatientController-searchDAssignedNo: got= "+doctorAssigned);
		...
		{
			infoLog.logActivities("in SearchPatientController-searchRAMQNo: "+e);
