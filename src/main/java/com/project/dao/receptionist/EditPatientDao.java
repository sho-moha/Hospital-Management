...
public class EditPatientDao 
{
	...
	@Transactional
	public int edit(String pid, Name name, String birthdate, String gender, String emailId, Long mobileNo, Long ramqNo,String country, String state, String city, Address address, String bloodGroup, String chronicDiseases,String medicineAllergy, String doctorId) 
	{
		//only enabled fields values is updated ..
		infoLog.logActivities("in EditPatientDao-edit: got= "+pid+" "+name+" "+birthdate+" "+gender+" "+emailId+" "+mobileNo+" "+ramqNo+" "+country+" "+state+" "+city+" "+address+" "+bloodGroup+" "+chronicDiseases+" "+medicineAllergy+" "+doctorId);
