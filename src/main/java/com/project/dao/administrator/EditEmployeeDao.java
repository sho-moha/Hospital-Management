...
public class EditEmployeeDao 
{
	...
	@Transactional
	public int edit(String eid, Name name, String birthdate, String gender, String emailId, Long mobileNo, Long ramqNo, String country, String state, String city, Address address, String role, String qualification, String specialization)
	{
		//only enabled fields values is updated ..
		infoLog.logActivities("in EditEmployeeDao-edit: got= "+eid+" "+name+" "+birthdate+" "+gender+" "+emailId+" "+mobileNo+" "+ramqNo+" "+country+" "+state+" "+city+" "+address+" "+role+" "+qualification+" "+specialization);
